...
public class ButtonUi extends FrameLayout {
    ...
    public ButtonUi(Context context, AttributeSet attrs, int defStyle) {
    ...
    public ButtonUi(Context context, AttributeSet attrs) {
